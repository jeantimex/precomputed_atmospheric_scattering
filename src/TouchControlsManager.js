/**
 * TouchControlsManager class for handling touch interactions
  ...
  onTouchMove(event) {
    ...
    if (event.touches.length === 2) {
      ...
      if (this.twoFingerMode === 'zoom') {
        ...
        this.demo.viewZenithAngleRadians = Math.max(0.1, Math.min(Math.PI / 2 - 0.1, this.demo.viewZenithAngleRadians));
